...
export const COORDINATOR_LOGIN_API = `${baseUrl}/coordinator/api/login`;
export const ACCOUNTANT_LOGIN_API = `${baseUrl}/accountant/api/login`;
export const INVESTOR_LOGIN_API = `${baseUrl}/investor/api/login`;
...
export const PLANT_MANAGER_LOGIN_API = `${baseUrl}/plant-manager/api/login`;
